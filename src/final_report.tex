...
speed (km/hour), air pressure, and snow.
...
predict the presence of absence of the various bird species. Osprey were more
likely to be spotted in the Eastern Glacier Bay region of focus during a week
...
the presence vs. absence of a bird. The most important deciding feature for the
...
three bird species.
    ...
    \begin{table}[h!]
        ...
        \begin{subtable}{0.49\textwidth}
            ...
            \begin{tabular}{lcccc}
                \toprule
                & \textbf{Dec. Tree} & \textbf{Random Forest} & \textbf{Gradient Boosting} & \textbf{XGBoost} \\
                \midrule
                ...
                Macro Avg. – F1 & 0.584 & 0.582 & \textbf{0.646} & 0.58 \\
                Balanced Accur. & \textbf{0.734} & 0.701 & 0.672 & 0.572 \\
                \bottomrule
            \end{tabular}
            \caption{Accuracy, Precision, Recall, and F1-score for Osprey Models}
        ...
        \begin{subtable}{0.49\textwidth}
            ...
            \begin{tabular}{lcccc}
                ...
                Macro Avg. – F1 & \textbf{0.688} & \textbf{0.688} & 0.585 & 0.55 \\
                Balanced Accur. & \textbf{0.707} & 0.693 & 0.584 & 0.551 \\
                \bottomrule
            \end{tabular}
            \caption{Accuracy, Precision, Recall, and F1-score for Atlantic Puffin Models}
    ...
    \begin{table}[h!]
        ...
        \begin{tabular}{lcccc}
            ...
            Macro Avg. – F1 & \textbf{0.613} & 0.612 & 0.568 & 0.58 \\
            Balanced Accur. & \textbf{0.823} & 0.716 & 0.581 & 0.584 \\
            \bottomrule
        \end{tabular}
        \caption{Accuracy, Precision, Recall, and F1-score for California Condor Models}
