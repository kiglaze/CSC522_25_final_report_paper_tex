...
Next, environmental and weather data obtained from the MeteoStat Python package was joined
with the bird geographical and temporal observation data. This provided more
...
per week in a more detailed fashion. The following tree-based classification
machine learning models were implemented to assist with these predictions:
Decision Tree with pruning, Random Forest, Gradient Boosted Trees, and Extreme
