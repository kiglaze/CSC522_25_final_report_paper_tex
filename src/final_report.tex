...
Martin’s paper uses random forests and extreme gradient boosting as some of the machine
learning models to predict spatial-temporal patterns of Balearic Shearwater
birds along some coastal regions in Europe. [1] This helped inform some of the
models that this research uses. Although they used numerous other models, such
as a Multilayer Perceptron Network (MLP), Random Forest and Extreme Gradient
Boosting still outperformed other models, including MLP.
...
mm of precipitation.
    ...
    spatio-temporal patterns in animal species abundance." Machine learning 44
        (2021): 289-301.
        \item \label{ref:fuentes_birdflow} Fuentes, Miguel, et al. "BirdFlow: Learning seasonal
